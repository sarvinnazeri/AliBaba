...
export default function Menu({ parvazDakheli, parvazKhareji, ghatar, tur }) {
    return (
        ...
        <div className="flex w-full justify-center flex-wrap border bg-white rounded-lg translate-y-[-80px]">
            ...
            <div className=" flex justify-center border w-full items-center *:mx-2 py-5 flex-wrap">
                ...
                <div className='w-full flex justify-between px-5'>
                    <button type="submit" className="border border-[rgb(226,167,46)] flex justify-center items-center px-[4px] py-[15px] rounded-md h-[45px] w-[180px] btn text-lg bg-[rgb(251,181,19)] text-black ">جستجو</button>
                    <Btn2 />
                    <Btn3 />
                    <Btn4 />
                </div>
